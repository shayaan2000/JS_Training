...
class RecipeView extends View {
  ...
  _errorMessage = "Sorry, we could not find a recipe, please try another one";
  ...
  _generateMarkup() {
    ...
    <figure class="recipe__fig">
      <img src="https://forkify-api.herokuapp.com/images/FlatBread21of1a180.jpg" alt="Tomato" class="recipe__img" />
